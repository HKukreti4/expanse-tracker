...
const Auth = () => {
  ...
  return (
    <div className="dark:bg-secondary-800 bg-white text-black dark:text-white rounded-xl h-[calc(100vh-16px)] m-2 overflow-hidden flex  gap-4  p-4">
      ...
      <div className="right flex-col  flex-1 bg-black/20 rounded-xl hidden md:flex items-center  justify-center">
        <div className="flex flex-col gap-6">
          ...
          <div className="px-8 py-2">
            ...
            /> */}
            <img
              src="https://imgs.search.brave.com/6bVQigMmC39pSfPiP21P3d453j6ODLuU9VOYDtJIlcU/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9rbm93/bGVkZ2UuaHVic3Bv/dC5jb20vaHViZnMv/YmVzdC1odG1sNS1h/ZG1pbi1kYXNoYm9h/cmQtdGVtcGxhdGVz/LTQtMjAyNDA4MjMt/NzI3NDkyNC53ZWJw"
              alt=""
              className="bg-blend-color-burn bg-primary-400 rounded-xl"
            />
          </div>
